class Prompts:
    IDENTIFY_PROMPT = """Analyse the given diagram and as per MITRE ATTACK Framework for Enterprise. 
                 ...
                 Provide special attention to perimeter words and ignore documented risk from common platforms.
                 Follow the guidelines provided."""
    PERIMETER_WORDS = """ perimeter_words = {
  "PerimeterKeywords": {
  ...
  "Values": [
    ...
    JSON_GUIDELINES_IDENTIFIED = """Ensure the output conforms precisely to this JSON structure: {identified_op_format}."""
